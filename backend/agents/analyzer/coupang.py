...
- berry_type이 "복분자+블랙베리"인 상품은 두 검색어 동시 노출을 위한 의도적 크로스 작명 전략이다
  → 이 상품명에서 복분자 또는 블랙베리 중 어느 쪽도 제거하는 제안 절대 금지
  → 상품명 수정 제안 시 반드시 두 키워드를 모두 유지해야 한다
  → 태그/키워드 제안 시 복분자 계열과 블랙베리 계열을 함께 포함시킨다
